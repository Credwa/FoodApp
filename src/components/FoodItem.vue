          ...
          <div class="grid-x grid-padding-x align-stretch align-middle">
            <div class="cell small-12 smedium-4 medium-4">
              <div class="vendor-profile">
                <h4 class="title line-bottom-left">FoodItem Profile</h4>
            ...
            <div class="cell small-12 smedium-8 medium-8">
              <div class="vendor-promos">
                <div class="promos-slider">
                  ...
                  <div class="promos-slide" v-for="VendorPromoPanel in VendorPromoPanels.Items" v-bind:key="VendorPromoPanel.vendorpromopanelid">
                ...
                <a class="results-card" href="#">
                  <div class="grid-x grid-margin-x">
                    ...
                    <div class="card-info cell small-6 smedium-12 medium-12">
                      ...
                      <span class="h4 product-price">{{VendorFoodItem.unitprice}}</span>
...
export default {
  ...
  methods: {
    fetch(page = 1) {
      ...
      if (this.loading)
        return;
      // this.ZVendorID = this.$route.params.ZVendorID
      ...
      axios({
        ...
        axios.post(process.env.API_URL + '/VendorPage-Vendor', {
          ...
          this.Vendor = response.data.Items[0]
          ...
          axios.post(process.env.API_URL + '/VendorPage-VendorPromoPanels', {
            ...
            this.VendorPromoPanels = response.data
            ...
            axios.post(process.env.API_URL + '/VendorPage-VendorFoodItems', {
              ...
              this.VendorFoodItems = response.data
              this.setpagenum(1)
            },
              (error) => {
                this.loading = false;
    ...
    filter() {
      if (this.countperpage == 0) {
        ...
        this.itemsofcurpage = this.VendorFoodItems.Items.slice((this.currentpage - 1) * this.countperpage, this.currentpage * this.countperpage)
      }
      this.pagecount = Math.round((this.VendorFoodItems.Items.length + 1) / this.countperpage)
