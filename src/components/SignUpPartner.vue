                            ...
                            <div class="grid-x grid-padding-x align-center">
                                ...
                                <div class="cell smedium-10">
                                    ...
                                    <form v-on:submit.prevent="submit($event)">
                                        ...
                                        <div class="form-floating-label has-icon">
                                            <input type="text" name="ZCompanyNameDesc1" required v-model="ZCompanyNameDesc1" />
                                            <label>Company name</label>
                                            <div class="i fas fa-building icon"></div>
                                        </div>
                                        <div class="form-floating-label has-icon">
        ...
        submit(e) {
            if (this.Email == "" || this.Password == "") {
                ...
                var data_array = {
                    ...
                    // ZCompanyName: this.ZCompanyNameDesc1,
